    ...
    function CountrySelecterDirective($compile: ng.ICompileService): ng.IDirective {
        return {
            ...
            compile: function (element: ng.IAugmentedJQuery, attr: ng.IAttributes, transclude: ng.ITranscludeFunction) {
                ...
                var options: string =
                    '<div style="' + style + '" class="dropdown"><button style="' + style + '; text-align: left;" class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">{{ctrl.ngModel.$viewValue}}<span class="caret" style="position: absolute; right: 10px; top: 48%;"></span></button>'
